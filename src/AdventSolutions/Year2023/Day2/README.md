...
number (like the ```11``` in ```Game 11: ...```) followed by a semicolon-separated list of subsets of cubes that were
...
minimum set of cubes in game 1 is ```48```. In games 2-5 it was ```12```, ```1560```, ```630```, and ```36```,
